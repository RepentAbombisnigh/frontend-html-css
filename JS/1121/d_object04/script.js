...
// JS의 원시 타입과 참조 타입을 기본 자료형과 객체 자료형으로 구분
...
// 객체 자료형
// 속성과 메소드를 가질 수 있는 모든 형태는 객체
//: 배열, 함수, 그 이외의 모든 자료형이 객체
...
// 해당 객체가 배열인지의 여부 확인하고 싶은 경우=  Array.isArray(배열명)
console.log(Array.isArray(a)); //true

console.log(typeof b); //function 
// 함수는 '실행이 가능한 객체'
// '일급 객체': 함수는 객체의 특성을 완벽하게 구현 가능하기 떄문에 일급 객체로써 해당 자료형을 그대로 가짐

//! 2. 기본 자료형을 객체로 선언
// const 객체 = new 객체자료형이름();
// new Number, new String, new Boolean etc
...
// 객체 그 자체를 출력할 경우 객체 형체로 출력
console.log(f);
// f는 객체이긴 하지만 숫자와 똑같이 활용 가능
// valueof() method를 사용하여 값을 추출가능
console.log(f + 1); // 274
console.log(f.valueOf()); //273

//! 프로토타입으로 메소드 추가
// 숫자 객체 전체에 어떤 속성과 메소드가 추가 가능하다면 기본 자료형 숫자도 속성과 메소드 사용이 가능
//: 어떤 객체의 prototype이라는 속성이 객체 전용틀, prototype 객체에 속성과 메소드를 추가하면 모든 객체(+ 기본 자료형)에서 해당 속성과 메소드를 사용 가능
...
// valueOf() 메소드
//: this ** n과 동일한 결과를 나타내지만 객체 내부에서 값을 꺼내 쓰는 것임을 명확하게 전달하기 위해서 사용
...
Array.prototype.contain = function () {
  return this.indexOf(data) >= 0;
}
// const j = '안녕하세요';
